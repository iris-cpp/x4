...
int main()
{
    BOOST_SPIRIT_X3_ASSERT_CONSTEXPR_CTORS(boost::spirit::x3::float_);
    BOOST_SPIRIT_X3_ASSERT_CONSTEXPR_CTORS(boost::spirit::x3::double_);
    BOOST_SPIRIT_X3_ASSERT_CONSTEXPR_CTORS(boost::spirit::x3::long_double);
