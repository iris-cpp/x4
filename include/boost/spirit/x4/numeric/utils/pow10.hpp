#ifndef BOOST_SPIRIT_X4_NUMERIC_UTILS_POW10_HPP
#define BOOST_SPIRIT_X4_NUMERIC_UTILS_POW10_HPP
...
{
    [[nodiscard]] static constexpr T call(unsigned dim) noexcept
    {
        using namespace std; // fallback
...
struct pow10_helper<float>
{
    ...
    {
        return static_cast<float>(pow10_helper<double>::call(dim));
    }
};
#endif // for IEEE-754
